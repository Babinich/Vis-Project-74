...
TEAM_DATA = pd.read_csv('Project/Data/team_data.csv', delimiter=',')
df = TEAM_DATA
...
def render(app: Dash):
    ...
    def update_scatter_plot(x_axis: str, y_axis: str, filter: int) -> dcc.Graph:
        ...
        order_of_categories = [{"group": ["group 1", "group 2", " group 3", "group 4", "group 5", "group 6", "group 7", "group 8"]}]
